...
1. The slider in it's default state.
2. A recommendation within the slider.
3. The mobile version. It's dismissible.
4. The responsive login/sign-up page on wripl.com allowing your users to connect socially, or to sign up for an account with no email required.
5. A recommendation within the mobile slider.
6. The recommendations widget in a sidebar, before 'connecting'.
7. The widget showing a personalised list of recommendations.
