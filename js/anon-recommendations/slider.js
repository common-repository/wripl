...
(function ($, Handlebars) {
    ...
    jQuery(document).ready(function ($) {
        ...
        if(showSliderFullWidth){
            slider.forcedDisplayed = true;
            slideOptionDefault = 0;
        }else{
            slider.forcedDisplayed = false;
            slideOptionDefault = -390;
        }
        ...
        if (isMobile) {
            ...
            sliderMode = "Slider";
            defaultPosition = slideOptionDefault;     // If the desired width of the slider changes.. so must this
            activePosition = 20;
